...
export default function About() {
  ...
  return (
    <section id="about" className="bg-cream pt-12 pb-24">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-14 px-5 sm:px-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)] lg:items-center">
        <div className="flex justify-center lg:justify-start">
          <div className="relative flex h-64 w-64 items-center justify-center rounded-full border border-line bg-white/70 sm:h-80 sm:w-80">
        ...
        <div>
          <span className="text-sm font-semibold uppercase tracking-[0.15em] text-gold-dark">
            {t('about.eyebrow')}
          </span>
          ...
          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
            {values.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="rounded-2xl border border-line bg-white/70 p-5">
